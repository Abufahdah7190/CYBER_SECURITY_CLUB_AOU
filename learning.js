(() => {
  ...
  async function issueCertificate(detail, slug, courseName) {
    ...
    try {
      ...
      renderCertificate(data.certificate, language);
      render();
    } catch (error) { alert(error.message); }
  }
  function renderCertificate(certificate, language) {
